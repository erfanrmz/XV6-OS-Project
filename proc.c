...
int
wait2(int *cbt,int *tat,int *wt) // CPU burst Time , Turn around time , waiting time
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
...
int
wait4(int *cbt,int *tat,int *wt , int *priority) // CPU burst Time , Turn around time , waiting time
{
  struct proc *p;
  int havekids, pid;
  struct proc *curproc = myproc();
